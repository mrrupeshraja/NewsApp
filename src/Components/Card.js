...
//           uri: item.urlToImage
//             ? item.urlToImage
//             : 'https://www.lyricswiz.com/wp-content/uploads/2023/12/animal-pehle-bhi-main.jpg',
//         }}
//         className="h-52 w-full rounded-md"
//         resizeMode="resize"
//       />
//       <View className="flex-1 px-2 my-2 relative">
//         <Text className="text-sm text-gray-900">{item.title}</Text>
//         <Text className="text-xm my-2">{item.description}</Text>
//         <View className="flex-row justify-between items-center my-2">
//           <Text className="text-xm text-gray-700">{item.author}</Text>
//           <Text className="text-xm text-gray-700">
//             {item.publishedAt.toLocaleString('en-GB', {timeZone: 'UTC'})}
//           </Text>
//         </View>
//         <TouchableOpacity
//           className="bg-redprimary px-4 py-1 mt-2 justify-center rounded-md flex-row space-x-2"
//           onPress={() =>
...
//           <ArrowRightIcon color="#fff" size={15} />
//         </TouchableOpacity>
//       </View>
//       <View className="absolute top-4 right-6 bg-redprimary px-4 rounded-md">
//         <Text className="text-xs text-white">{item.source.name}</Text>
//       </View>
//     </View>
//   );
// };
